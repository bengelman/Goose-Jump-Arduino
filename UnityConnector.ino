...
int winner[] = {
  NOTE_B5, NOTE_C6, NOTE_B5, NOTE_A5, NOTE_C6, NOTE_B5, NOTE_A5, NOTE_G5, NOTE_FS5, NOTE_G5, NOTE_E5, NOTE_CS5, NOTE_D5, NOTE_E5, NOTE_F5, NOTE_E5, NOTE_F5, NOTE_B4, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_G5, NOTE_C6
};
int winnerNotes[] = {
  8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 4, 8, 8, 2, 4, 2
}
int melodyLength = 14;
float songDelay = 0;
float songMillis = 0;
